...
var FilesystemAPIProvider = (function(Q) {
	...
	FSAPI.prototype = {
		...
		rm: function(path, rmJustAttachments) {
			var deferred = Q.defer();
...
var LargeLocalStorage = (function(Q) {
	...
	LargeLocalStorage.prototype = {
		...
		* @method rm
		* @param {string} docKey
		* @param {boolean} rmJustAttachments
		* @returns {promise} resolved when removal completes, rejected if the removal fails.
		*/
		rm: function(docKey, rmJustAttachments) {
			this._checkAvailability();
			return this._impl.rm(docKey, rmJustAttachments);
		},
